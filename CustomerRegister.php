...
require_once "../vitrine/controllers/ClienteController.php";
...
<main class="form-signin">
    <div class="container-fluid">
        <form action="#" method="post">
            ...
            <h1 class="h3 mb-3 fw-normal">Registre no site</h1>
            <div class="container-fluid">
                <form action="#" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="CustomerLogin.php" class="btn btn-danger">Voltar</a>
                    </div>
