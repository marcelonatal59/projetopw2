...
require_once "controllers/LoginClienteController.php";
...
if (isset($_POST['login'])){
    ...
    if (LoginClienteController::getInstance()->login($email, $senha)){
...
<main class="form-signin">
    <form action="#" method="post">
        ...
        <a class="nav-link" href="CustomerRegister.php"><span data-feather="users"></span>
            Registre-se
        </a>
