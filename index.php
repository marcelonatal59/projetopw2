...
require_once "views/validarClienteSessao.php";
...
<head>
    ...
    <title>Pagina Inicial-Vitrine</title>


    <!-- Bootstrap core CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <?php
    require_once "../views/assets.php";
    ?>
    <!-- Favicons -->
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Vitrine5P</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="viewCarrinho.php">Carrinho</a>
                </li>
            ...
            foreach($lstTresProdutos as $produto){
                echo "<div class='col'>
                            <div class='card h-100'>
                                <img src='../images/products/".$produto->getImagem()."' class='card-img-top' alt='...' width='356' height='279'>
                                <div class='card-body'>
